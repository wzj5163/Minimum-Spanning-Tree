...
plot(ZOO, screens=1, col=c("black", "lightblue", "pink","darkslateblue","red","brown", "gold", "grey", "green", "blue3","darkorchid2"), ylab="", xlab="")
dev.off()
#dev.new()
png("MSTCC_PortRet2.png", width=500, height=400, bg = "transparent")
plot(ZOO[,c(1,2,3,4,11)], screens=1, col=c("black", "lightblue", "pink","darkslateblue", "darkorchid2"), lwd=1, ylab="", xlab="")
dev.off()
